    ...
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl md:text-8xl font-black italic mb-4 tracking-tighter uppercase text-[var(--text-h)]">
            BEAT THE MARKET.
          </h1>
          <p className="text-xl text-[var(--text)] max-w-xl mx-auto font-medium">
        ...
        <div>
          ...
          <div className="space-y-6 text-[var(--text)] leading-relaxed text-lg">
            <p>
              ...
              is currently in{" "}
              <strong className="text-[var(--text-h)]">Phase 1</strong>,
              focusing on a high-performance <strong>React</strong> frontend and
              client-side persistence. We use state-driven logic to manage your
              dream fleet instantly without server lag.
            </p>
            <p>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex flex-col">
                <span className="text-[var(--text-h)] font-bold text-xl uppercase tracking-tight">
